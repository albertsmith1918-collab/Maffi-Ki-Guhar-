/* clarity-js v0.8.62: https://github.com/microsoft/clarity (License: MIT) */
!(function () {
  "use strict";
  var t,
    e,
      ...
      $n(this, void 0, void 0, function () {
        ...
        return ta(this, function (l) {
          switch (l.label) {
                ...
                ? ((Te = null),
                  ...
                  tn
                    ? ((a = JSON.stringify(
                      ...
                      n &&
                        r.length > 0 &&
                        a.length + i.length + r.length > 65536 &&
                        (r = ""),
                      (o =
                        (d = { e: a, a: i, p: r }).p.length > 0
                          ? '{"e":' + d.e + ',"a":' + d.a + ',"p":' + d.p + "}"
                          : '{"e":' + d.e + ',"a":' + d.a + "}"),
                      n ? ((c = null), [3, 3]) : [3, 1])
                    : [2])
            ...
            case 3:
              return (
                Jn(2, (u = c) ? u.length : o.length),
                Sr(o, u, tn.sequence, n),
                (Ee = []),
                e && ((Se = []), (ke = 0), (we = 0), (Oe = !1)),
                [2]
              );
